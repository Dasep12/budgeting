                ...
                <ul id="accordion-menu">
                    ...
                    <li class="dropdown open">
                        <a href="javascript:;" class="dropdown-toggle">
                            <span class="micon bi bi-textarea-resize"></span><span class="mtext">Budgeting</span>
                        </a>
                        <ul class="submenu">
                            <li><a href="<?= base_url('Anggaran') ?>">Anggaran Tahunan</a></li>
                            <li><a href="form-basic.html">Total Budget</a></li>
                            <li>
                                <a href="<?= base_url('Input_Budget') ?>">Input Budget</a>
                            </li>
                            <li><a href="form-wizard.html">Input Activity Budget</a></li>
                            <li><a href="html5-editor.html">Review Budget</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a href="javascript:;" class="dropdown-toggle">
                        ...
                        <ul class="submenu">
                            <li><a href="<?= base_url('Anggaran') ?>">Actual & Planning Budget</a></li>
                            <li><a href="<?= base_url('Anggaran') ?>">Report Pengeluaran</a></li>
                        </ul>
                    </li>
