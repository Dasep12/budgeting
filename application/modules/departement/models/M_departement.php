...

{
    ...
    public function daftarActualActivity($dept_id,  $col)
    {
        ...
        $co = "tjp." . $col;
        $query = $this->db->query("SELECT mb.kode_budget as kode, tjp.id as id_trans  ,  tjp.remarks , tjp.request_code , mjt.jenis_transaksi  ,md.nama_departement , tjp.status_retur , tjp.master_jenis_bayar_id as tipe,
