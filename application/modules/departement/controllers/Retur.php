...
class Retur extends CI_Controller
{
    ...
    public function form_input()
    {
        ...
        $query = $this->db->query("SELECT tjp.request_code , tjp.id  from transaksi_jenis_pembayaran tjp 
        ...
        and tjp.master_departement_id = '" . $this->session->userdata('departement_id') . "'
        ");
        $data = [
            'list'          => $query,
            'uri'           => $this->uri->segment(2),
