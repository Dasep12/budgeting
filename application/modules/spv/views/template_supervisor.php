...
<body>
    ...
    <div class="left-side-bar">
        <div class="brand-logo">
            <a href="index.html">
                <img style="height:120px" src="<?= base_url('assets/') ?>src/images/btp.png" alt="" class="dark-logo" />
                <img style="height:120px" src="<?= base_url('assets/') ?>src/images/btp.png" alt="" class="light-logo" />
            </a>
