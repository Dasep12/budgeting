...
<head>
    <!-- Basic Page Info -->
    <meta charset="utf-8" />
    <title>BTI-E-Budget System</title>
...
<body>
    ...
    <div class="left-side-bar">
        <div class="brand-logo">
            <a href="#">
                <img style="height:70px" src="<?= base_url('assets/') ?>src/images/logoBenecom.jpg" alt="" class="dark-logo" />
                <img style="height:70px" src="<?= base_url('assets/') ?>src/images/logoBenecom.jpg" alt="" class="light-logo" />
            </a>
