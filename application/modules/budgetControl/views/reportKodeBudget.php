<div class="row">
    <div class="col-lg-6">
        <div class="card">
            ...
            <div class="card-body">
                <form method="post" action="<?= base_url('budgetControl/Reporting/perKodeBudget') ?>">
    ...
    <div class="col-lg-6">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?= base_url('budgetControl/Reporting/allKodeBudget') ?>" method="post">
                    <div class="form-group">
                        <label>Departement</label>
...
<script>
    $('select[name=tahun').on('change', function() {
        ...
        $.ajax({
            url: "<?= base_url('budgetControl/Reporting/getKode') ?>",
            method: "POST",
            data: {
                tahun: tahun,
                departement: dept
