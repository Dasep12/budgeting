                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php } else { ?>
                                ...
                                <a onclick="return confirm('Yakin reject ?')" href="<?= base_url('budgetControl/Approve_trans/approve?id_budget=' . $rm->id_trans . '&kode=2') ?>" class="badge badge-danger">Reject</a>
