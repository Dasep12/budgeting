...
<div class="tab-content" id="myTabContent">
    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
        <div class="card-box mb-30">
            <form action="<?= base_url('manager_v2/Approv_voucher/multiApprove') ?>" method="post">
                <div class="pd-20">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <a href="<?= base_url('manager_v2/Approve_voucher/approve?id_budget=' . $df->id . '&kode=1') ?>" onclick="return confirm('Yakin approve ?')" class="badge badge-success">Approved</a>
                                            <a onclick="return confirm('Yakin reject ?')" href="<?= base_url('manager_v2/Approve_voucher/approve?id_budget=' . $df->id . '&kode=2') ?>" class="badge badge-danger">Reject</a>
...
<script>
    $(function() {
        ...
        $("#exampleModal").on("show.bs.modal", function(event) {
            ...
            // AJAX request
            $.ajax({
                url: "<?= base_url('manager_v2/Approve_voucher/viewDetailPlant') ?>",
                type: 'post',
                data: {
                    id: userid,
                    'file1': file1,
