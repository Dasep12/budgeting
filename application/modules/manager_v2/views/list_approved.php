...
<div class="tab-content" id="myTabContent">
    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
        <div class="card-box mb-30">
            <form action="<?= base_url('manager_v2/Approved/multiApprove') ?>" method="post">
                <div class="pd-20">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <a href="<?= base_url('manager_v2/Approved/approve?id_budget=' . $df->id_budget . '&kode=1') ?>" onclick="return confirm('Yakin approve ?')" class="badge badge-success">Approved</a>

                                            <a onclick="return confirm('Yakin reject ?')" href="<?= base_url('manager_v2/Approved/approve?id_budget=' . $df->id_budget . '&kode=2') ?>" class="badge badge-danger">Reject</a>
...
<script>
    $(function() {
        ...
        $('#exampleModal').on("show.bs.modal", function(event) {
            ...
            // AJAX request
            $.ajax({
                url: "<?= base_url('manager_v2/Approved/viewDetailPlant') ?>",
                type: 'post',
                data: {
                    id: userid
                },
