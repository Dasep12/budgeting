<div class="row">
    <div class="col-lg-6">
        <div class="card">
            ...
            <div class="card-body">
                <form method="post" action="<?= base_url('finance/Reporting/perKodeBudget') ?>">
    ...
    <div class="col-lg-6">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?= base_url('finance/Reporting/allKodeBudget') ?>" method="post">
                    <div class="form-group">
                        <label>Departement</label>
...
<script>
    $('select[name=tahun]').on('change', function() {
        ...
        var dept = $("select[name=departement] option:selected").val();
        $.ajax({
            url: "<?= base_url('finance/Reporting/getKode') ?>",
            method: "POST",
            data: {
                tahun: tahun,
                departement: dept
