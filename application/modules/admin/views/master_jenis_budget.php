                ...
                foreach ($data->result() as $dpt) : ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="#" data-toggle="modal" data-target="#edit-data" data-backdrop="static" data-keyboard="false" class="badge badge-success" data-jenis_budget="<?= strtoupper($dpt->jenis_budget) ?>"><i class="fa fa-eye"></i></a>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="card-body">
                    ...
                    <input type="text" readonly autocomplete="off" id="jenis_budget" class="form-control">
